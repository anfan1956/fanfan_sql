...
, f (personID, hrs, clientid, commissions,hourly_wage, min_wage, PIT,SocTax, charge_date, commission) as (
...
select charge_date, personID, clientid, 
	...
	commissions,
	anfan_release.acc.accountid_func('комиссионные', 'RUR') from f WHERE f.commission='True' UNION
select charge_date, personID, clientid, 
	anfan_release.acc.journalid_func('hard cash'),
