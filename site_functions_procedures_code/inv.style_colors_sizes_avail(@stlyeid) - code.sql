...
, _s (styleid, colorid, sizeid, qty, price, cost, divisionid, division, barcodeid, category) as (
	select 
...
go
select * from inv.style_colors_sizes_avail(19996)
