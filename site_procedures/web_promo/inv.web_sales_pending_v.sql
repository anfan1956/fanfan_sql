...
create view inv.webOrders_toShip_v as
	...
	from _all_transactions a
		...
		left join web.delivery_parcels p on p.barcodeid=a.barcodeid
		left join web.deliveryLogs dl on dl.logid=p.logid
		left join web.deliveryAddresses ad on ad.addressid=dl.addressid
go	
